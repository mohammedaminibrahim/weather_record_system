...
if(isset($_POST['submit'])){
  $stationid = sterilize($_POST['stationid']);
  $password = sterilize($_POST['password']);

if(empty($stationid) && empty($password)){
  $_SESSION['message'] = "All Fields are required...**";
  $_SESSION['alert'] = "alert alert-warning";
} else {
  $sqlSelectEmail = "SELECT * from stations WHERE stationid = '$stationid'";
  ...
  <header id="header" class="navbar navbar-expand navbar-light navbar-absolute-top">
    <div class="container-fluid">
      <nav class="navbar-nav-wrap">
        ...
        <!-- Default Logo -->
        <a class="navbar-brand d-flex d-lg-none" href="index.php" aria-label="Front">
          -->
        </a>
        <!-- End Default Logo -->
          ...
          <div class="flex-grow-1 p-5">
            ...
            <figure class="text-center">
              ...
              <figcaption class="blockquote-footer blockquote-light">
                <div class="mb-3">
                  <img class="avatar avatar-circle" src="assets/img/newborn.png" alt="Image Description">
                </div>
        ...
        <?php endif;?>
            ...
            <form action="" method="POST">
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control form-control-lg" name="stationid" id="signupModalFormLoginEmail" placeholder="email@site.com" aria-label="email@site.com" required>
