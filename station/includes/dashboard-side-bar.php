<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
  ...
  <div class="sidebar-inner px-4 pt-3">
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      ...
      <div class="collapse-close d-md-none">
        <a href="#sidebarMenu" data-bs-toggle="collapse"
            ...
            <svg class="icon icon-xs" fill="currentColor" viewBox="0 0 20 20" xmlns=""><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </a>
      </div>
    </div>
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item ">
        <a href="././view-daily-records.php" class="nav-link">
          <span class="sidebar-icon">
          ...
          <span class="sidebar-text">View Daily Records</span>
        </a>
      </li>
      <li class="nav-item ">
        <a href="././view-stations.php" class="nav-link">
          <span class="sidebar-icon">
          ...
          <span class="sidebar-text">Import Daily Records</span>
        </a>
      </li>
      <a href="././settings.php">
